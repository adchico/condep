...
//    }
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE tbl_contreq SET cr_BLNo = ?, cr_containerNo = ?, cr_shippingLine = ?, cr_or = ?, cr_fcl = ?, cr_empty = ?, cr_masterbl = ?, cr_contgua = ?, cr_trucking = ?, cr_plateno = ?, cr_driver = ?, id_Deposit = ?, cr_Encodedby = ? WHERE id_contreq = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array($cr_BLNo,$cr_containerNo,$cr_shippingLine,$cr_or,$cr_fcl,$cr_empty,$cr_masterbl,$cr_contgua,$cr_trucking,$cr_plateno,$cr_driver,$id_Deposit,$cr_Encodedby,$id_contreq));
...
<!- Select of ShippingLine ->
                          <SELECT  readonly name="cr_shippingLine" type="text" placeholder="Shipping Line" value="<?php echo !empty($cr_shippingLine)?$cr_shippingLine:'';?>">
                              <option value="<?php echo $cr_shippingLine;?>" selected><?php echo $cr_shippingLine;?></option>
                              <?php
...
<!- Select of trucking ->
                    ...
                    <div class="control-group <?php echo !empty($cr_EncodedbyError)?'error':'';?>">
                      ...
                      <div class="controls">
                          <input name="cr_Encodedby" type="text"  placeholder="cr_Encodedby" value="<?php echo !empty($cr_Encodedby)?$cr_Encodedby:'';?>">
                    ...
                    <div class="control-group <?php echo !empty($cr_EncodedDateError)?'error':'';?>">
                      ...
                      <div class="controls">
                          <input name="cr_EncodedDate" type="text"  placeholder="cr_EncodedDate" value="<?php echo !empty($cr_EncodedDate)?$cr_EncodedDate:'';?>">
