...
<table class="table table-striped table-bordered">
  <thead>
    ...
    <th>ENCODED DATE</th>        <td><?php echo $data['EncodedDate'];?></td>
            ...
            <a href="reports/A_CheqRefundrpt.php?cheqNo='<?php echo $data['cheqno']; ?>'"  class="btn btn-primary pull-right">Print Cheq</a>
...
<br/>
          ...
          <!--            <th>CheqNo</th>
              ...
              <?php
               ...
               $pdo = Database::connect();
               $sqlDep = "SELECT * FROM `tbl_deposit` RIGHT JOIN tbl_cheq ON tbl_deposit.`cheqno` = tbl_cheq.`cheqno` WHERE tbl_deposit.`cheqno` = ". $cheqno;
