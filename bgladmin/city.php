...
<body>
  <br>  <br>  <br>
    <div class="container-fluid offset8">
            ...
            <div class="row">
              <p>
                   <a href="create_city.php" class="btn btn-primary">Create</a>
      ...
      //             include 'database.php';
                   ...
                   $sql = 'SELECT * FROM tbl_city ORDER BY city ASC';
                   foreach ($pdo->query($sql) as $row) {
                            echo '<tr>';
                            echo '<td>'. $row['id_city'] . '</td>';
                            echo '<td>'. $row['city'] . '</td>';
                            echo '<td><center>';
                            echo '<a class="btn btn-success" href="update_city.php?id_city='.$row['id_city'].'">Update</a>';
                            echo '</center></td>';
                            if ($_SESSION['u_ulevel']=="Admin" OR $_SESSION['u_ulevel']=="ADMIN"){
                            echo '<td><center>';
                            echo '<a class="btn btn-danger" href="delete_city.php?id_city='.$row['id_city'].'">Delete</a>';
                            echo '</center></td>';
                            }
                            echo '</tr>';
                   }
