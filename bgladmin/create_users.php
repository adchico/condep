...
require 'uploader.php';
        ...
        if (!empty($_FILES['image']['name']) && !$uploader->valid($_FILES['image']))
    {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO users (user_uid,user_first,user_last,user_email,user_pwd,userlevel,image,Encodedby,EncodedDate) values(?,?,?,?,?,?,?,?,?)";
            $q = $pdo->prepare($sql);
            
            $q->execute(array($user_uid,$user_first,$user_last,$user_email,$hashedpwd,$userlevel,$image,$Encodedby,$EncodedDate));
    ...
    <div id="div-background" class="container">
                ...
                <div class="span10 offset1">
                  <br>
                    ...
                    <form class="form-horizontal" action="create_users.php" method="post" enctype="multipart/form-data">
  ...
  <div class="controls">
      ...
      <?php endif; ?>
                      ...
                      <div class="form-actions" id="form-transparent">
                          ...
                          <a class="btn" href="/betty/bgladmin/users.php">Back</a>
                        </div>
                    </form>
