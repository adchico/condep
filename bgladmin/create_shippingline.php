...
include_once '../logstat.php';
    ...
    if ( !empty($_POST)) {
        ...
        if (empty($ShippingLinefull)) {
            $ShippingLinefullError = 'Please enter ShippingLinefull';
            $valid = false;
        }
    ...
    //       $valid = false;
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO tbl_shippingline (ShippingLine,ShippingLinefull,ShipReq,Address1,Address2,Address3,Contact1,Contact2,Authorize1,Authorize2,Encodedby,EncodedDate) values(?,?,?,?,?,?,?,?,?,?,?,?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($ShippingLine,$ShippingLinefull,$ShipReq,$Address1,$Address2,$Address3,$Contact1,$Contact2,$Authorize1,$Authorize2,$Encodedby,$EncodedDate));

            $message = 'You Have Successfully Added '. $ShippingLine . '!';
            echo "<script type='text/javascript'>alert(' $message '); setTimeout(\"location.href = 'shippingline.php';\",1500);</script>";
            Database::disconnect();
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3 class="offset2">Create a ShippingLine</h3>
                    </div>
                    <br>

                    <form class="form-horizontal" action="create_shippingline.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($ShippingLinefullError)?'error':'';?>">
                        <label class="control-label">ShippingLine full Name</label>
                        <div class="controls">
                      ...
                      <div class="control-group <?php echo !empty($ShipReqError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ShipReq" type="text"  placeholder="Contact Person" value="<?php echo !empty($ShipReq)?$ShipReq:'';?>">
