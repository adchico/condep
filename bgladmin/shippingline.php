...
<body>
  <br>  <br>  <br>
    <div class="container-fluid offset2">
            <div class="row">
                <h3>Table Shipping Line </h3>
            </div>
            <div class="row">
              <p>
                   <a href="create_shippingline.php" class="btn btn-primary">Create</a>
      ...
      //             include 'database.php';
                   ...
                   foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<td>';
                            echo '<a class="btn btn-default " href="read_shippingline.php?id_Shipline='.$row['id_Shipline'].'">Details</a>';
                            echo '</td>';
                            echo '<td>';
                            echo '<a class="btn btn-success " href="update_shippingline.php?id_Shipline='.$row['id_Shipline'].'">Update</a>';
                            echo '</td>';
                            if ($_SESSION['u_ulevel']=="Admin" OR $_SESSION['u_ulevel']=="ADMIN"){
                            echo '<td>';
                            echo '<a class="btn btn-danger " href="delete_shippingline.php?id_Shipline='.$row['id_Shipline'].'">Delete</a>';
                            echo '</td>';
                            }
                            echo '</tr>';
                   }
